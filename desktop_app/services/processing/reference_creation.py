...
from desktop_app.services.camera.models.corner import Corner
...
from desktop_app.helpers import corner_helper, reference_helper
...
def create(
    ...
    products = functions.extract_products_from_frame(
        depth_frame, camera_intrinsics, settings, selected_product
    )

    references = functions.create_product_references(
        products,
